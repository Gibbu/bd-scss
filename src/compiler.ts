...
if (missingMeta.length > 0) log.error([`Your ${log.code('meta')} object is missing the following required properties:`, missingMeta]);

export const compile = async (options: Options) => {
